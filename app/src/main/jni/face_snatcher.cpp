...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_grayscale(JNIEnv *env,
                                                                                        jobject obj,
                                                                                        jintArray src,
                                                                                        jint width,
                                                                                        jint height,
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_approximateColor(JNIEnv *env,
                                                                                      jobject obj,
                                                                                      jintArray src,
                                                                                      jint width,
                                                                                      jint height,
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_noiseRemove(JNIEnv *env,
                                                                                      jobject obj,
                                                                                      jintArray src,
                                                                                      jint width,
                                                                                      jint height) {
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_negative(JNIEnv *env,
                                                                                      jobject obj,
                                                                                      jintArray src,
                                                                                      jint width,
                                                                                      jint height) {
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_brightness(JNIEnv *env,
                                                                                       jobject obj,
                                                                                       jintArray src,
                                                                                       jint width,
                                                                                       jint height) {
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_posterize(JNIEnv *env,
                                                                                  jobject obj,
                                                                                  jintArray src,
                                                                                  jint width,
                                                                                  jint height,
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_posterizeBright(JNIEnv *env,
                                                                                   jobject obj,
                                                                                   jintArray src,
                                                                                   jint width,
                                                                                   jint height,
...
JNIEXPORT jintArray JNICALL Java_snatcher_face_com_facesnatcher_NativeHelper_gradation(JNIEnv *env,
                                                                                   jobject obj,
                                                                                   jintArray src,
                                                                                   jint width,
                                                                                   jint height) {
...
JNIEXPORT jintArray Java_snatcher_face_com_facesnatcher_NativeHelper_facedetect(JNIEnv *env,
                                                                                     jobject obj,
                                                                                     jintArray src,
                                                                                     jint width,
                                                                                     jint height
